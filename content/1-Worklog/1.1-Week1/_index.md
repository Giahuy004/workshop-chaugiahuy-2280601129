...
| 6 | - Learn about the Shared Responsibility Model and Cloud economics concepts. | 24/04/2026 | 24/04/2026 | <https://cloudjourney.awsstudygroup.com/> |
| 7 | - Practice comprehensive IAM Lab: Create a Custom Policy using JSON to restrict access by IP or by time. | 25/04/2026 | 25/04/2026 | <https://cloudjourney.awsstudygroup.com/> |

### Week 1 Achievements:
* Successfully created AWS account
* Found enough members to carry out the project
* Successfully called basic AWS APIs from local Terminal
* Wrote and successfully applied advanced IAM Policy
