...
- **Amazon EC2 (t3.medium)**: Máy ảo dành cho học máy trong môi trường thử nghiệm. Chi phí hoạt động 24/7: 33,00 USD/tháng. Chi phí tối ưu (chỉ áp dụng cho mục đích thử nghiệm): **2,50 USD/tháng**.  
- **AWS WAF**: Tường lửa bảo vệ API Gateway. Chi phí hoạt động 24/7: 7,00 USD/tháng. Chi phí tối ưu (chỉ áp dụng cho mục đích thử nghiệm): **0,50 USD/tháng**.  
- **Điểm cuối VPC**: Cổng kết nối nội bộ. Chi phí 24/7: 9,00 USD/tháng. Chi phí tối ưu (chỉ áp dụng cho mục đích thử nghiệm): **0,60 USD/tháng**.  
- **AWS KMS**: Khóa mã hóa dữ liệu. Chi phí: **1,00 USD/tháng**.  
- **AWS Secrets Manager**: Kho lưu trữ mật khẩu/bí mật. Chi phí: **0,40 USD/tháng**.  
- **AWS Config**: Kiểm tra cấu hình tự động. Chi phí 24/7: 1,00 USD/tháng. Chi phí tối ưu: **0,20 USD/tháng**.  
- **Các dịch vụ Serverless khác (S3, Lambda, API Gateway, SQS, DynamoDB, Amplify)**: Được bao gồm hoàn toàn trong gói **AWS Free Tier** trong giai đoạn phát triển/thử nghiệm.  

*Tổng chi phí ước tính*:  
- **Vận hành 24/7**: Khoảng 51,40 USD/tháng (Khoảng 1.250.000đ/tháng)  
- **Tối ưu hóa chạy thử nghiệm (Chỉ bật khi test)**: **Khoảng 5,20 USD/tháng** (Khoảng 125.000đ/tháng)  
